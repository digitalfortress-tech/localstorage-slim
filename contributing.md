# Contributing to localstorage-slim
...
### Using localstorage-slim?
Share with us, and we'll mention it on the project homepage. When adding site to the *list of sites using localstorage-slim*, please mention where to verify this in the PR description.

### Improve documentation

As a user of localstorage-slim, you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of localstorage-slim

## Reporting Issues

- Found a problem? Want a new feature? First of all see if your issue or idea has [already been reported](https://github.com/niketpathak/localstorage-slim/issues).
- If not, just open a [new clear and descriptive issue](https://github.com/niketpathak/localstorage-slim/issues/new).
